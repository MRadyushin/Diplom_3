...
public class LoginPage {
    ...
    public RecoveryPasswordPage clickForgotPassword() {
        linkText.get(1).click();
        RecoveryPasswordPage forgotPasswordPage = Selenide.page(RecoveryPasswordPage.class);
        forgotPasswordPage.waitForLoadRecoveryPasswordPage();
